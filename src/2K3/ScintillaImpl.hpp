...
public:
	...
	Colour GetAdditionalCaretFore() { return static_cast<Colour>(Call(SCI_GETADDITIONALCARETFORE)); }
	Colour GetCaretFore() { return static_cast<Colour>(Call(SCI_GETCARETFORE)); }
	Colour GetCaretLineBack() { return static_cast<Colour>(Call(SCI_GETCARETLINEBACK)); }
	Colour GetEdgeColour() { return static_cast<Colour>(Call(SCI_GETEDGECOLOUR)); }
	Colour GetHotspotActiveBack() { return static_cast<Colour>(Call(SCI_GETHOTSPOTACTIVEBACK)); }
	Colour GetHotspotActiveFore() { return static_cast<Colour>(Call(SCI_GETHOTSPOTACTIVEFORE)); }
	Colour GetMarginBackN(int margin) { return static_cast<Colour>(Call(SCI_GETMARGINBACKN, margin)); }
	Colour IndicGetFore(int indicator) { return static_cast<Colour>(Call(SCI_INDICGETFORE, indicator)); }
	Colour IndicGetHoverFore(int indicator) { return static_cast<Colour>(Call(SCI_INDICGETHOVERFORE, indicator)); }
	Colour StyleGetBack(int style) { return static_cast<Colour>(Call(SCI_STYLEGETBACK, style)); }
	Colour StyleGetFore(int style) { return static_cast<Colour>(Call(SCI_STYLEGETFORE, style)); }
	...
	Position GetSelectedText(char* text) { return Call(SCI_GETSELTEXT, 0, reinterpret_cast<intptr_t>(text)); }
	...
	int AllocateExtendedStyles(int numberStyles) { return static_cast<int>(Call(SCI_ALLOCATEEXTENDEDSTYLES, numberStyles)); }
	int AllocateSubStyles(int styleBase, int numberStyles) { return static_cast<int>(Call(SCI_ALLOCATESUBSTYLES, styleBase, numberStyles)); }
	int AnnotationGetLines(Line line) { return static_cast<int>(Call(SCI_ANNOTATIONGETLINES, line)); }
	int AnnotationGetStyle(Line line) { return static_cast<int>(Call(SCI_ANNOTATIONGETSTYLE, line)); }
	int AnnotationGetStyleOffset() { return static_cast<int>(Call(SCI_ANNOTATIONGETSTYLEOFFSET)); }
	int AnnotationGetStyles(Line line, char* styles) { return static_cast<int>(Call(SCI_ANNOTATIONGETSTYLES, line, reinterpret_cast<intptr_t>(styles))); }
	int AnnotationGetText(Line line, char* text) { return static_cast<int>(Call(SCI_ANNOTATIONGETTEXT, line, reinterpret_cast<intptr_t>(text))); }
	int AnnotationGetVisible() { return static_cast<int>(Call(SCI_ANNOTATIONGETVISIBLE)); }
	int AutoCGetCaseInsensitiveBehaviour() { return static_cast<int>(Call(SCI_AUTOCGETCASEINSENSITIVEBEHAVIOUR)); }
	int AutoCGetCurrent() { return static_cast<int>(Call(SCI_AUTOCGETCURRENT)); }
	int AutoCGetCurrentText(char* text) { return static_cast<int>(Call(SCI_AUTOCGETCURRENTTEXT, 0, reinterpret_cast<intptr_t>(text))); }
	int AutoCGetMaxHeight() { return static_cast<int>(Call(SCI_AUTOCGETMAXHEIGHT)); }
	int AutoCGetMaxWidth() { return static_cast<int>(Call(SCI_AUTOCGETMAXWIDTH)); }
	int AutoCGetMulti() { return static_cast<int>(Call(SCI_AUTOCGETMULTI)); }
	int AutoCGetOrder() { return static_cast<int>(Call(SCI_AUTOCGETORDER)); }
	int AutoCGetSeparator() { return static_cast<int>(Call(SCI_AUTOCGETSEPARATOR)); }
	int AutoCGetTypeSeparator() { return static_cast<int>(Call(SCI_AUTOCGETTYPESEPARATOR)); }
	int ChangeLexerState(Position start, Position end) { return static_cast<int>(Call(SCI_CHANGELEXERSTATE, start, end)); }
	int DescribeKeyWordSets(char* descriptions) { return static_cast<int>(Call(SCI_DESCRIBEKEYWORDSETS, 0, reinterpret_cast<intptr_t>(descriptions))); }
	int DescribeProperty(const char* name, char* description) { return static_cast<int>(Call(SCI_DESCRIBEPROPERTY, reinterpret_cast<uintptr_t>(name), reinterpret_cast<intptr_t>(description))); }
	int DescriptionOfStyle(int style, char* description) { return static_cast<int>(Call(SCI_DESCRIPTIONOFSTYLE, style, reinterpret_cast<intptr_t>(description))); }
	int DistanceToSecondaryStyles() { return static_cast<int>(Call(SCI_DISTANCETOSECONDARYSTYLES)); }
	int EOLAnnotationGetStyle(Line line) { return static_cast<int>(Call(SCI_EOLANNOTATIONGETSTYLE, line)); }
	int EOLAnnotationGetStyleOffset() { return static_cast<int>(Call(SCI_EOLANNOTATIONGETSTYLEOFFSET)); }
	int EOLAnnotationGetText(Line line, char* text) { return static_cast<int>(Call(SCI_EOLANNOTATIONGETTEXT, line, reinterpret_cast<intptr_t>(text))); }
	int EOLAnnotationGetVisible() { return static_cast<int>(Call(SCI_EOLANNOTATIONGETVISIBLE)); }
	int FoldDisplayTextGetStyle() { return static_cast<int>(Call(SCI_FOLDDISPLAYTEXTGETSTYLE)); }
	int GetAccessibility() { return static_cast<int>(Call(SCI_GETACCESSIBILITY)); }
	int GetAdditionalSelAlpha() { return static_cast<int>(Call(SCI_GETADDITIONALSELALPHA)); }
	int GetAutomaticFold() { return static_cast<int>(Call(SCI_GETAUTOMATICFOLD)); }
	int GetBidirectional() { return static_cast<int>(Call(SCI_GETBIDIRECTIONAL)); }
	int GetCaretLineBackAlpha() { return static_cast<int>(Call(SCI_GETCARETLINEBACKALPHA)); }
	int GetCaretLineFrame() { return static_cast<int>(Call(SCI_GETCARETLINEFRAME)); }
	int GetCaretPeriod() { return static_cast<int>(Call(SCI_GETCARETPERIOD)); }
	int GetCaretSticky() { return static_cast<int>(Call(SCI_GETCARETSTICKY)); }
	int GetCaretStyle() { return static_cast<int>(Call(SCI_GETCARETSTYLE)); }
	int GetCaretWidth() { return static_cast<int>(Call(SCI_GETCARETWIDTH)); }
	int GetCharAt(Position pos) { return static_cast<int>(Call(SCI_GETCHARAT, pos)); }
	int GetCharacterCategoryOptimization() { return static_cast<int>(Call(SCI_GETCHARACTERCATEGORYOPTIMIZATION)); }
	int GetCodePage() { return static_cast<int>(Call(SCI_GETCODEPAGE)); }
	int GetControlCharSymbol() { return static_cast<int>(Call(SCI_GETCONTROLCHARSYMBOL)); }
	int GetCursor() { return static_cast<int>(Call(SCI_GETCURSOR)); }
	int GetDefaultFoldDisplayText(char* text) { return static_cast<int>(Call(SCI_GETDEFAULTFOLDDISPLAYTEXT, 0, reinterpret_cast<intptr_t>(text))); }
	int GetDocumentOptions() { return static_cast<int>(Call(SCI_GETDOCUMENTOPTIONS)); }
	int GetEOLMode() { return static_cast<int>(Call(SCI_GETEOLMODE)); }
	int GetEdgeMode() { return static_cast<int>(Call(SCI_GETEDGEMODE)); }
	int GetExtraAscent() { return static_cast<int>(Call(SCI_GETEXTRAASCENT)); }
	int GetExtraDescent() { return static_cast<int>(Call(SCI_GETEXTRADESCENT)); }
	int GetFoldLevel(Line line) { return static_cast<int>(Call(SCI_GETFOLDLEVEL, line)); }
	int GetFontQuality() { return static_cast<int>(Call(SCI_GETFONTQUALITY)); }
	int GetIMEInteraction() { return static_cast<int>(Call(SCI_GETIMEINTERACTION)); }
	int GetIdentifier() { return static_cast<int>(Call(SCI_GETIDENTIFIER)); }
	int GetIdleStyling() { return static_cast<int>(Call(SCI_GETIDLESTYLING)); }
	int GetIndent() { return static_cast<int>(Call(SCI_GETINDENT)); }
	int GetIndentationGuides() { return static_cast<int>(Call(SCI_GETINDENTATIONGUIDES)); }
	int GetIndicatorCurrent() { return static_cast<int>(Call(SCI_GETINDICATORCURRENT)); }
	int GetIndicatorValue() { return static_cast<int>(Call(SCI_GETINDICATORVALUE)); }
	int GetLayoutCache() { return static_cast<int>(Call(SCI_GETLAYOUTCACHE)); }
	int GetLexer() { return static_cast<int>(Call(SCI_GETLEXER)); }
	int GetLexerLanguage(char* language) { return static_cast<int>(Call(SCI_GETLEXERLANGUAGE, 0, reinterpret_cast<intptr_t>(language))); }
	int GetLineCharacterIndex() { return static_cast<int>(Call(SCI_GETLINECHARACTERINDEX)); }
	int GetLineEndTypesActive() { return static_cast<int>(Call(SCI_GETLINEENDTYPESACTIVE)); }
	int GetLineEndTypesAllowed() { return static_cast<int>(Call(SCI_GETLINEENDTYPESALLOWED)); }
	int GetLineEndTypesSupported() { return static_cast<int>(Call(SCI_GETLINEENDTYPESSUPPORTED)); }
	int GetLineIndentation(Line line) { return static_cast<int>(Call(SCI_GETLINEINDENTATION, line)); }
	int GetLineState(Line line) { return static_cast<int>(Call(SCI_GETLINESTATE, line)); }
	int GetMainSelection() { return static_cast<int>(Call(SCI_GETMAINSELECTION)); }
	int GetMarginCursorN(int margin) { return static_cast<int>(Call(SCI_GETMARGINCURSORN, margin)); }
	int GetMarginLeft() { return static_cast<int>(Call(SCI_GETMARGINLEFT)); }
	int GetMarginMaskN(int margin) { return static_cast<int>(Call(SCI_GETMARGINMASKN, margin)); }
	int GetMarginOptions() { return static_cast<int>(Call(SCI_GETMARGINOPTIONS)); }
	int GetMarginRight() { return static_cast<int>(Call(SCI_GETMARGINRIGHT)); }
	int GetMarginTypeN(int margin) { return static_cast<int>(Call(SCI_GETMARGINTYPEN, margin)); }
	int GetMarginWidthN(int margin) { return static_cast<int>(Call(SCI_GETMARGINWIDTHN, margin)); }
	int GetMargins() { return static_cast<int>(Call(SCI_GETMARGINS)); }
	int GetMaxLineState() { return static_cast<int>(Call(SCI_GETMAXLINESTATE)); }
	int GetModEventMask() { return static_cast<int>(Call(SCI_GETMODEVENTMASK)); }
	int GetMouseDwellTime() { return static_cast<int>(Call(SCI_GETMOUSEDWELLTIME)); }
	int GetMultiPaste() { return static_cast<int>(Call(SCI_GETMULTIPASTE)); }
	int GetNamedStyles() { return static_cast<int>(Call(SCI_GETNAMEDSTYLES)); }
	int GetNextTabStop(Line line, int x) { return static_cast<int>(Call(SCI_GETNEXTTABSTOP, line, x)); }
	int GetPhasesDraw() { return static_cast<int>(Call(SCI_GETPHASESDRAW)); }
	int GetPositionCache() { return static_cast<int>(Call(SCI_GETPOSITIONCACHE)); }
	int GetPrimaryStyleFromStyle(int style) { return static_cast<int>(Call(SCI_GETPRIMARYSTYLEFROMSTYLE, style)); }
	int GetPrintColourMode() { return static_cast<int>(Call(SCI_GETPRINTCOLOURMODE)); }
	int GetPrintMagnification() { return static_cast<int>(Call(SCI_GETPRINTMAGNIFICATION)); }
	int GetPrintWrapMode() { return static_cast<int>(Call(SCI_GETPRINTWRAPMODE)); }
	int GetProperty(const char* key, char* value) { return static_cast<int>(Call(SCI_GETPROPERTY, reinterpret_cast<uintptr_t>(key), reinterpret_cast<intptr_t>(value))); }
	int GetPropertyExpanded(const char* key, char* value) { return static_cast<int>(Call(SCI_GETPROPERTYEXPANDED, reinterpret_cast<uintptr_t>(key), reinterpret_cast<intptr_t>(value))); }
	int GetPropertyInt(const char* key, int defaultValue) { return static_cast<int>(Call(SCI_GETPROPERTYINT, reinterpret_cast<uintptr_t>(key), defaultValue)); }
	int GetPunctuationChars(char* characters) { return static_cast<int>(Call(SCI_GETPUNCTUATIONCHARS, 0, reinterpret_cast<intptr_t>(characters))); }
	int GetRectangularSelectionModifier() { return static_cast<int>(Call(SCI_GETRECTANGULARSELECTIONMODIFIER)); }
	int GetRepresentation(const char* encodedCharacter, char* representation) { return static_cast<int>(Call(SCI_GETREPRESENTATION, reinterpret_cast<uintptr_t>(encodedCharacter), reinterpret_cast<intptr_t>(representation))); }
	int GetScrollWidth() { return static_cast<int>(Call(SCI_GETSCROLLWIDTH)); }
	int GetSearchFlags() { return static_cast<int>(Call(SCI_GETSEARCHFLAGS)); }
	int GetSelAlpha() { return static_cast<int>(Call(SCI_GETSELALPHA)); }
	int GetSelectionMode() { return static_cast<int>(Call(SCI_GETSELECTIONMODE)); }
	int GetSelections() { return static_cast<int>(Call(SCI_GETSELECTIONS)); }
	int GetStatus() { return static_cast<int>(Call(SCI_GETSTATUS)); }
	int GetStyleAt(Position pos) { return static_cast<int>(Call(SCI_GETSTYLEAT, pos)); }
	int GetStyleFromSubStyle(int subStyle) { return static_cast<int>(Call(SCI_GETSTYLEFROMSUBSTYLE, subStyle)); }
	int GetSubStyleBases(char* styles) { return static_cast<int>(Call(SCI_GETSUBSTYLEBASES, 0, reinterpret_cast<intptr_t>(styles))); }
	int GetSubStylesLength(int styleBase) { return static_cast<int>(Call(SCI_GETSUBSTYLESLENGTH, styleBase)); }
	int GetSubStylesStart(int styleBase) { return static_cast<int>(Call(SCI_GETSUBSTYLESSTART, styleBase)); }
	int GetTabDrawMode() { return static_cast<int>(Call(SCI_GETTABDRAWMODE)); }
	int GetTabMinimumWidth() { return static_cast<int>(Call(SCI_GETTABMINIMUMWIDTH)); }
	int GetTabWidth() { return static_cast<int>(Call(SCI_GETTABWIDTH)); }
	int GetTag(int tagNumber, char* tagValue) { return static_cast<int>(Call(SCI_GETTAG, tagNumber, reinterpret_cast<intptr_t>(tagValue))); }
	int GetTechnology() { return static_cast<int>(Call(SCI_GETTECHNOLOGY)); }
	int GetViewWS() { return static_cast<int>(Call(SCI_GETVIEWWS)); }
	int GetVirtualSpaceOptions() { return static_cast<int>(Call(SCI_GETVIRTUALSPACEOPTIONS)); }
	int GetWhitespaceChars(char* characters) { return static_cast<int>(Call(SCI_GETWHITESPACECHARS, 0, reinterpret_cast<intptr_t>(characters))); }
	int GetWhitespaceSize() { return static_cast<int>(Call(SCI_GETWHITESPACESIZE)); }
	int GetWordChars(char* characters) { return static_cast<int>(Call(SCI_GETWORDCHARS, 0, reinterpret_cast<intptr_t>(characters))); }
	int GetWrapIndentMode() { return static_cast<int>(Call(SCI_GETWRAPINDENTMODE)); }
	int GetWrapMode() { return static_cast<int>(Call(SCI_GETWRAPMODE)); }
	int GetWrapStartIndent() { return static_cast<int>(Call(SCI_GETWRAPSTARTINDENT)); }
	int GetWrapVisualFlags() { return static_cast<int>(Call(SCI_GETWRAPVISUALFLAGS)); }
	int GetWrapVisualFlagsLocation() { return static_cast<int>(Call(SCI_GETWRAPVISUALFLAGSLOCATION)); }
	int GetXOffset() { return static_cast<int>(Call(SCI_GETXOFFSET)); }
	int GetZoom() { return static_cast<int>(Call(SCI_GETZOOM)); }
	int IndicGetAlpha(int indicator) { return static_cast<int>(Call(SCI_INDICGETALPHA, indicator)); }
	int IndicGetFlags(int indicator) { return static_cast<int>(Call(SCI_INDICGETFLAGS, indicator)); }
	int IndicGetHoverStyle(int indicator) { return static_cast<int>(Call(SCI_INDICGETHOVERSTYLE, indicator)); }
	int IndicGetOutlineAlpha(int indicator) { return static_cast<int>(Call(SCI_INDICGETOUTLINEALPHA, indicator)); }
	int IndicGetStyle(int indicator) { return static_cast<int>(Call(SCI_INDICGETSTYLE, indicator)); }
	int IndicatorAllOnFor(Position pos) { return static_cast<int>(Call(SCI_INDICATORALLONFOR, pos)); }
	int IndicatorValueAt(int indicator, Position pos) { return static_cast<int>(Call(SCI_INDICATORVALUEAT, indicator, pos)); }
	int MarginGetStyle(Line line) { return static_cast<int>(Call(SCI_MARGINGETSTYLE, line)); }
	int MarginGetStyleOffset() { return static_cast<int>(Call(SCI_MARGINGETSTYLEOFFSET)); }
	int MarginGetStyles(Line line, char* styles) { return static_cast<int>(Call(SCI_MARGINGETSTYLES, line, reinterpret_cast<intptr_t>(styles))); }
	int MarginGetText(Line line, char* text) { return static_cast<int>(Call(SCI_MARGINGETTEXT, line, reinterpret_cast<intptr_t>(text))); }
	int MarkerAdd(Line line, int markerNumber) { return static_cast<int>(Call(SCI_MARKERADD, line, markerNumber)); }
	int MarkerGet(Line line) { return static_cast<int>(Call(SCI_MARKERGET, line)); }
	int MarkerHandleFromLine(Line line, int which) { return static_cast<int>(Call(SCI_MARKERHANDLEFROMLINE, line, which)); }
	int MarkerNumberFromLine(Line line, int which) { return static_cast<int>(Call(SCI_MARKERNUMBERFROMLINE, line, which)); }
	int MarkerSymbolDefined(int markerNumber) { return static_cast<int>(Call(SCI_MARKERSYMBOLDEFINED, markerNumber)); }
	int NameOfStyle(int style, char* name) { return static_cast<int>(Call(SCI_NAMEOFSTYLE, style, reinterpret_cast<intptr_t>(name))); }
	int PointXFromPosition(Position pos) { return static_cast<int>(Call(SCI_POINTXFROMPOSITION, 0, pos)); }
	int PointYFromPosition(Position pos) { return static_cast<int>(Call(SCI_POINTYFROMPOSITION, 0, pos)); }
	int PropertyNames(char* names) { return static_cast<int>(Call(SCI_PROPERTYNAMES, 0, reinterpret_cast<intptr_t>(names))); }
	int PropertyType(const char* name) { return static_cast<int>(Call(SCI_PROPERTYTYPE, reinterpret_cast<uintptr_t>(name))); }
	int StyleGetCase(int style) { return static_cast<int>(Call(SCI_STYLEGETCASE, style)); }
	int StyleGetCharacterSet(int style) { return static_cast<int>(Call(SCI_STYLEGETCHARACTERSET, style)); }
	int StyleGetFont(int style, char* fontName) { return static_cast<int>(Call(SCI_STYLEGETFONT, style, reinterpret_cast<intptr_t>(fontName))); }
	int StyleGetSize(int style) { return static_cast<int>(Call(SCI_STYLEGETSIZE, style)); }
	int StyleGetSizeFractional(int style) { return static_cast<int>(Call(SCI_STYLEGETSIZEFRACTIONAL, style)); }
	int StyleGetWeight(int style) { return static_cast<int>(Call(SCI_STYLEGETWEIGHT, style)); }
	int TagsOfStyle(int style, char* tags) { return static_cast<int>(Call(SCI_TAGSOFSTYLE, style, reinterpret_cast<intptr_t>(tags))); }
	int TextHeight(Line line) { return static_cast<int>(Call(SCI_TEXTHEIGHT, line)); }
	int TextWidth(int style, const char* text) { return static_cast<int>(Call(SCI_TEXTWIDTH, style, reinterpret_cast<intptr_t>(text))); }
	...
	void ChangeSelectionColour(bool hide) { Call(SCI_HIDESELECTION, hide); }
