...
namespace
{
	...
	JS_CLASS_OPS(JsEnumerator::FinalizeJsObject, nullptr)
...
namespace mozjs
{
	...
	JsEnumerator::JsEnumerator(JSContext* cx, EnumVARIANTComPtr pEnum) : pJsCtx_(cx), pEnum_(pEnum) {}

	std::unique_ptr<JsEnumerator> JsEnumerator::CreateNative(JSContext* cx, IUnknown* pUnknown)
	{
