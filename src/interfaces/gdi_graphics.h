...
namespace mozjs
{
	...
	public:
		...
		uint32_t CalcTextWidth(const std::wstring& str, JsGdiFont* font, bool use_exact = false);
		uint32_t CalcTextWidthWithOpt(size_t optArgCount, const std::wstring& str, JsGdiFont* font, bool use_exact);
