...
namespace
{
	...
	JS_CLASS_OPS(JsMainMenuManager::FinalizeJsObject, nullptr)

	JS_CLASS("MainMenuManager")
...
namespace mozjs
{
	...
	JsMainMenuManager::JsMainMenuManager(JSContext* cx) : pJsCtx_(cx) {}

	std::unique_ptr<JsMainMenuManager> JsMainMenuManager::CreateNative(JSContext* cx)
	{
