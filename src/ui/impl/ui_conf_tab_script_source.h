...
namespace smp::ui
{
	...
	class CConfigTabScriptSource : public CDialogImpl<CConfigTabScriptSource>, public CDialogResize<CConfigTabScriptSource>, public ITab
	{
	public:
		enum
		{
...
#pragma warning(pop)
	...
	private:
		...
		std::array<std::unique_ptr<smp::IUiDdx>, 4> ddx_;
